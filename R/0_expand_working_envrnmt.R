...
paths<-link2GI::initProj(projRootDir = projRootDir,
                         projFolders = c("analysis/data/dtm2014/",
                                         "analysis/data/dtm2014_merged/",
                                         "analysis/data/dtm2018a/",
                                         "analysis/data/dtm2018b/",
                                         "analysis/data/dtm2018c/",
                                         "analysis/data/dtm2018d/",
                                         "analysis/data/dtm2018e/",
                                         "analysis/data/dtm2018f/",
                                         "analysis/data/dtm2018g/",
                                         "analysis/data/dtm2018h/",
                                         "analysis/data/dtm2018i/",
                                         "analysis/data/barrows/",
                                         "analysis/data/LiDAR_data/",
                                         "analysis/scripts/",
                                         "analysis/qgis/",
                                         "R/", "man/", "tests/"),
                         global = TRUE,
